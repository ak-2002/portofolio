export default async function about() {
    ...
    <div class="flex flex-col items-center pb-10">
        ...
        <div class="flex mt-4 md:mt-6">
            ...
            <br/>
            <a href="mailto:andrew.wanyonyi1@gmail.com" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Email</a>
